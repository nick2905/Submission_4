package com.dicoding.submission_4.Adapter;
...
import com.dicoding.submission_4.Activity.MovieDetailActivity;
...
public class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.ListViewHolder>{
    ...
    public void onBindViewHolder(@NonNull final ListViewHolder holder, final int position) {
        ...
        Glide.with(holder.itemView.getContext())
                .load(BuildConfig.API_URL_PHOTO + films.get(position).getMv_photo())
